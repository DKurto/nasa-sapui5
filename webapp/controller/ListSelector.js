sap.ui.define([
		...
		return BaseObject.extend("nasa.test.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias nasa.test.model.ListSelector
			 */
			 ...
			 * @return {nasa.test.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
