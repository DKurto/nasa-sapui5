sap.ui.define([
	...
	return BaseObject.extend("nasa.test.model.GroupSortState", {
		 ...
		 * @alias nasa.test.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "MeasureUnit");
			}
