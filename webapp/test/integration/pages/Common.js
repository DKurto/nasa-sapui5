sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("nasa/test/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("nasa.test.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["nasa/test/localService/mockserver"], function (mockserver) {
