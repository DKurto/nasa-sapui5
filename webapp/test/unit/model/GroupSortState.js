sap.ui.define([
		"nasa/test/model/GroupSortState",
	...
	QUnit.test("Should always return a sorter when sorting", function (assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("MeasureUnit").length, 1, "The sorting by MeasureUnit returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by MeasureUnit and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("MeasureUnit");
